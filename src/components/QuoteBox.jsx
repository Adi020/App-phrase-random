const QuoteBox = ({ phrase, handleChangeQuote }) => {
  return (
    <div className="flex flex-col items-center gap-16 pb-8">
      <article className="scroll-container overflow-y-scroll h-[400px]  rounded-[50px] text-center flex justify-center items-start from-[#b7b7d2] max-w-[600px] bg-gradient-to-b  p-10" >
