const QuoteBox = ({ phrase, handleChangeQuote }) => {
  return (
    <>
      <article className="text-4xl text-[#573675] rounded-[50px] text-center flex justify-center items-center max-w-[600px] min-h-[350px] bg-gradient-to-b from-[#b7b7d2] p-10">
