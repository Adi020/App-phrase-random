const QuoteBox = ({ phrase, handleChangeQuote }) => {
  return (
    <div className="flex flex-col items-center gap-16 pb-8">
      <article className="scroll-container text-4xl overflow-y-scroll min-h-[350px] text-[#573675] rounded-[50px] text-center flex justify-center items-center max-w-[600px] bg-gradient-to-b from-[#b7b7d2] p-10" >
